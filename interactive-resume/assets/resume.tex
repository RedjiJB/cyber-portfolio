...
\begin{center}
    ...
    \small \raisebox{-0.1\height}\faPhone\ +1 (819)-319-6405 ~ \href{mailto:jean0319@algonquinlive.com}{\raisebox{-0.2\height}\faEnvelope\  \underline{jean0319@algonquinlive.com}} ~ 
...
\section{Professional Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Windows Admin Toolkit}{2025 - Present}
      {Developer (Open Source)}{Remote}
      \resumeItemListStart
        \resumeItem{Developed PowerShell automation suite for Windows system administration, streamlining repetitive tasks across Active Directory, backup management, and disk encryption workflows}
        \resumeItem{Built user management module for bulk AD account creation, password policy enforcement, group membership management, and automated onboarding/offboarding processes}
        \resumeItem{Created automated backup system with full/incremental/differential modes, AES-256 encryption, compression, and cloud storage integration for enterprise environments}
        \resumeItem{Implemented BitLocker automation tools with recovery key management, TPM integration, and compliance reporting for organizational security policies}
        \resumeItem{Designed modular architecture with comprehensive error handling, logging, and configuration management for maintainable enterprise-grade scripts}
    \resumeItemListEnd
